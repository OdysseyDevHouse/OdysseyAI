...
/**
 * The online-bookings settings, now the "Online bookings" tab of /settings.
 *
 * Named for what its own first card already said. The screen was called
 * "Reservations" while every heading on it said bookings — and "reservation"
 * separately names the stock a job card claims, which is a different thing
 * entirely (see job_stock_reservations).
 *
 ...
 */
export default function OnlineBookingsForm({
  settings,
  reservePath,
}: {
